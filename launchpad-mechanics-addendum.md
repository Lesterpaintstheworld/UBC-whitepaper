...
### Revenue Scope
The revenue distribution system applies differently based on swarm type and origin:

1. Consumer-Facing Swarms
- All revenue is included in the distribution system
- Applies to all consumer transactions and services
- Full revenue participation regardless of source

2. Early Stage Swarms
- All revenue is included in the distribution system
- Applies to swarms that started in the UBC ecosystem
- Full revenue participation maintained throughout lifecycle

3. B2B Partner Swarms
The revenue distribution only applies to:
...
For example, a B2B partner's external revenue (from independent operations outside the UBC ecosystem) is not subject to this distribution model, while all revenue from consumer-facing swarms and early stage swarms is included.
...
<img src="revenue_distribution_50.png" width="500" alt="Revenue Distribution 50% Autonomy"/>
...
<img src="secondary_market_fees.png" width="500" alt="Secondary Market Fees"/>
