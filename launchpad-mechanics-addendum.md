...
Purchased UBC follows a three-way distribution:
- 50% is permanently burned, continuously reducing supply
- 25% goes directly to swarm shareholders as base rewards
- 25% is distributed based on the swarm's autonomy level:
  * Autonomy Level 0%: Full amount goes to swarm team
  * Autonomy Level 100%: Full amount goes to shareholders
  * Intermediate levels split proportionally between team and shareholders

For example:
- At 0% autonomy: Team receives full 25% (maximum team allocation)
- At 50% autonomy: Team and shareholders each receive 12.5%
- At 100% autonomy: Shareholders receive full 25% (maximum shareholder allocation)
...
- Shareholders receive guaranteed base returns plus autonomy-based rewards
- Teams can adjust their revenue share based on their operational autonomy
